...
gulp.task('code', function () {
  return gulp.src('frontend/views/lot/index.php')
    .pipe(browserSync.reload({
      stream: true
    }))
});
...
gulp.task('max', gulp.parallel('styles', 'scripts', 'browser-sync-max', 'watch'));
gulp.task('server', gulp.parallel('styles', 'scripts', 'browser-sync-server', 'watch'));