...
class m180116_073828_lookup_user extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->insert(self::TABLE_LOOKUP, ['name' => 'Агент',                   'code' => 3, 'property_id' => self::USER_ROLE, 'position' => 3]);
        $this->insert(self::TABLE_LOOKUP, ['name' => 'Арбитражный управляющий', 'code' => 4, 'property_id' => self::USER_ROLE, 'position' => 4]);
        $this->insert(self::TABLE_LOOKUP, ['name' => 'Пользователь',            'code' => 5, 'property_id' => self::USER_ROLE, 'position' => 5]);
