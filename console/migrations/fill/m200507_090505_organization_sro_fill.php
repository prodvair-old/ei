...
class m200507_090505_organization_sro_fill extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->batchInsert(self::TABLE, ['model', 'parent_id', 'activity', 'title', 'full_title', 'inn', 'ogrn', 'reg_number', 'email', 'phone', 'website', 'status', 'created_at', 'updated_at'], $organizations);
