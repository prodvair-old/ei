...
class m200416_134224_lot extends Migration
{
    ...
    public function safeUp()
    {
        $this->createTable(self::TABLE, [
            ...
            'ordinal_number'    => $this->integer()->notNull(),
            ...
            'status_changed_at' => $this->integer()->notNull(),
		...
		$this->addCommentOnColumn(self::TABLE, 'ordinal_number', 'Порядковый номер Лота в Торге');
		...
		$this->addCommentOnColumn(self::TABLE, 'status_changed_at', 'Дата и время изменения статуса');
