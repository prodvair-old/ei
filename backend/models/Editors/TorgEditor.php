...
class TorgEditor extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['msgId', 'typeId', 'tradeTypeId'], 'required'],
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID торга',
            'publisherId' => 'Менеджер *',
            'ownerId' => 'Владельца торга',
            'etpId' => 'Торговой площадки',
            'msgId' => 'Номер сообщения *',
            'type' => 'Вид имущества',
            'typeId' => 'Вида имущества *',
