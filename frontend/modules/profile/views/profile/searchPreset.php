            ...
            <div class="col-12 col-lg-9">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="form-draft-payment">
                        ...
                        <?php if (!Yii::$app->user->isGuest && Yii::$app->accessManager->isSubscriber(Yii::$app->user->getId())) : ?>
                            <div class="row search-preset-list" id="">
                                            ...
                                            <div class="search-preset-box__right">
                                                <div class="search-preset-box__check">
                                                    ...
                                                    <div class="toggle normal">
                                                        ...
                                                        <input id="normal-<?= $searchQuerу->id ?>" class="normal-input"
                                                               data-id="<?= $searchQuerу->id ?>"
                                                               type="checkbox" <?= $searchQuerу->send_email ? 'checked' : '' ?>/>
                                                        <label class="toggle-item"
                                                               for="normal-<?= $searchQuerу->id ?>"></label>
                                                    </div>
                                                </div>
                                                <a href="#" class="search-preset-box__del search-preset-box__del-js"
                                                   data-id="<?= $searchQuerу->id ?>"><i class="far fa-trash-alt"></i></a>
                                            </div>
                                        </div>
                                    <? }
                                } ?>
                                <div class="p-15 search-preset__info <?= $searchQueries[0] ? '' : 'active' ?>">
                                    ...
                                    <p>На странице <a href="<?= Url::to(['/all/lot-list']) ?>" class="text-dark"><u>поисковой
                                                выдачи</u></a> после фильтрации нажмите <span class="text-primary">"Отслеживать поиск"</span>.
                                    </p>
                                </div>
                        ...
                        <?php else: ?>
                            Поисковые отслежевания доступны по <a href="/tariff">подписке</a>
                        <?php endif; ?>
                    </div>
