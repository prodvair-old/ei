            ...
            <aside class="col-12 col-lg-4">
                ...
                <div class="col-inner  pv-15">
                  <?= Html::submitButton('<i class="ion-android-search"></i> Поиск', ['class' => 'btn btn-primary btn-block load-list-click', 'name' => 'login-button']) ?>
                        ...
                        <? //=($model->minPrice || $model->maxPrice)? '' : 'collaps'?><!--" >-->
                        ...
                        <div class="box-content">
                            <div class="row">
                                <div class="col-6">
                                    <?= $form->field($model, 'minPrice')->textInput(['class' => 'lot__price-min form-control', 'placeholder' => 'Цена от'])->label(false); ?></div>
                                    <div class="col-6">
                                        <?= $form->field($model, 'maxPrice')->textInput(['class' => 'lot__price-max form-control', 'placeholder' => 'Цена до'])->label(false); ?></div>
                                    </div>

                                    <div class="mb-10"></div>

                                    <input id="price_range" data-min="
                                    <?= $price[ 'min' ] ?>" data-max="<?= $price[ 'max' ] ?>"/>
                                </div>

                            </div>
                            <!---->
                            <!--                        <div class="sidebar-box bankrupt-type sidebar-box__collaps -->
                            <? //=($model->etp)? '' : 'collaps'?><!--">-->
                            <!---->
                            ...
                            <!--                        <div class="sidebar-box zalog-type sidebar-box__collaps -->
                            <? //= ($model->owners) ? '' : 'collaps' ?><!--">-->
                            <!---->
                            ...
                            <!--                        <div class="sidebar-box sidebar-box__collaps -->
                            <? //= ($model->imageCheck || $model->archivCheck) ? '' : 'collaps' ?><!--">-->
                            <!--                            -->
                    ...
                    <div class="pager-wrappper mt-40">
                        ...
                        <div class="pager-innner">
                            ...
                            <div class="row align-items-center text-center text-lg-left">
                                ...
                                <!--                                    --><? // if (count($lots) > 0) { ?>
                                <!--                                        Выведено от -->
                                <? //= $offset + 1 ?><!-- до --><? //= $offset + count($lots) ?><!-- лотов. Всего -->
                                <? //= $count ?><!--.-->
                                <!--                                    --><? // } else { ?>
                                <!--                                        Лотов не найдено-->
                                <!--                                    --><? // } ?>
