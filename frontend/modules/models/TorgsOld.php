 ...
 */
class TorgsOld extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['bankruptId'], 'exist', 'skipOnError' => true, 'targetClass' => EiLotBankrupt::className(), 'targetAttribute' => ['bankruptId' => 'id']],
            [['caseId'], 'exist', 'skipOnError' => true, 'targetClass' => EiLotCase::className(), 'targetAttribute' => ['caseId' => 'id']],
            [['etpId'], 'exist', 'skipOnError' => true, 'targetClass' => EiLotEtp::className(), 'targetAttribute' => ['etpId' => 'id']],
            [['publisherId'], 'exist', 'skipOnError' => true, 'targetClass' => EiLotManager::className(), 'targetAttribute' => ['publisherId' => 'id']],
            [['ownerId'], 'exist', 'skipOnError' => true, 'targetClass' => EiLotOwner::className(), 'targetAttribute' => ['ownerId' => 'id']],
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            'id' => 'ID торга',
            'publisherId' => 'ID кем опубликован торг.',
            'ownerId' => 'ID владельца торга.',
            'etpId' => 'ID торговой площадки.',
            'msgId' => 'Номер сообщения',
            'type' => 'Вид имущества. Арестованное, банкротом или залоговое имущество',
            ...
            'tradeType' => 'Тип лота. Публичное предложение или открытый аукцион.',
    ...
    public function getOwner() {
        return $this->hasOne(Owners::className(), ['id' => 'ownerId']);
    }
}
