...
<aside class=" sidebar-wrapper no-border mt-20 mt-lg-0" itemscope itemtype="">
    ...
    <div class="booking-box">
        ...
        <div class="box-heading"><h3 class="h6 text-white text-uppercase">Информация о лоте11</h3></div>
        ...
        <div class="box-content">
            ...
            <!--            <h4 class="line-125 --><? //=($lot->torg->tradeTypeId == 2)? 'text-muted' : ''?><!--"> -->
            <? //= Yii::$app->formatter->asCurrency($lot->start_price)?><!-- </h4>-->
